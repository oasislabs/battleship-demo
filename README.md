...
2. Clone this repository: `git clone https://github.com/oasis-game-framework/battleship-demo`
3. (optionally) Start a local Parity instance for debugging: `cd battleship-demo && ./scripts/start-parity.sh`
